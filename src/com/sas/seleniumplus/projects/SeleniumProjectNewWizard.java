...
public class SeleniumProjectNewWizard extends Wizard implements INewWizard, IExecutableExtension {
	...
	private SeleniumProjectPageWizard _pageOne;
	...
	public void addPages() {
	    ...
	    _pageOne = new SeleniumProjectPageWizard(PAGE_NAME);
	    _pageOne.setTitle(WIZARD_NAME);
	    _pageOne.setDescription(WIZARD_DESCRIPTION);
	    addPage(_pageOne);
	}

	public SeleniumProjectNewWizard() {
