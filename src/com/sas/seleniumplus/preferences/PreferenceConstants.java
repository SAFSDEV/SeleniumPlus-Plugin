...
public class PreferenceConstants {
	...
	public static String UPDATESITE_PLUGIN_URL = "UpdatesitePluginUrl";
	public static String TIME_OUT = "timeout";
	public static int TIME_OUT_VALUE = 5; // update site timeout in minutes
	public static String SERVER_TIMEOUT = "servertimeout";
	public static String BROWSER_TIMEOUT = "browsertimeout";
	public static String SERVER_TIMEOUT_VALUE = "20";
	public static String BROWSER_TIMEOUT_VALUE = "60";
